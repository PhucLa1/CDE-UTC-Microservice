...
export default function UserInfoSheet({ node, userProject, currentRole, projectId }: { node: ReactNode, userProject: UserProject, currentRole: Role, projectId: number }) {
    ...
    const { mutate: mutateUpdate, isPending: isPendingUpdate } = useMutation({
        ...
        mutationFn: () => teamApiRequest.changeRole({
            projectId: projectId,
            role: role,
            ...
            <SheetContent className="w-[400px]">
                <div className="flex flex-col items-center space-y-3 py-4">
                    ...
                    <div className="text-center">
                        ...
                        <a href="mailto:phucminhbeos@gmail.com" className="text-blue-500 flex items-center gap-2">
                ...
                <Card className="p-4 space-y-2">
                    ...
                    <p className="text-sm text-gray-500">Ngày tham gia: <span className="font-medium">{userProject.dateJoined}</span></p>
                    <p className="text-sm text-gray-500">Trạng thái: <span className="font-medium text-green-600">
                        {userProject.userProjectStatus == UserProjectStatus.Active ? "Đã vào" : "Đang chờ"}
                    </span></p>
                    <p className="text-sm text-gray-500">Vị trí:
                        <Select disabled={currentRole == Role.Admin ? false : true} value={role.toString()} onValueChange={(value) => {
                            ...
                            <SelectContent>
                                <SelectItem value={Role.Member.toString()}>Người dùng</SelectItem>
